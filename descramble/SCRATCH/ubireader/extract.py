...
start_offset = 0
block_size = 262144
outpath = '/home/joost/Projects/gitea/echodotv3/flashdump/exported/ubi'
perms = False # required runnning as root ?

#path = '/home/joost/Projects/gitea/echodotv3/flashdump/exported/partitions/userdata.bin'
#end_offset = 469237760 # userdata

path = '/home/joost/Projects/gitea/echodotv3/flashdump/exported/partitions/persist.bin'
end_offset = 8388608 # persist

print('exporting from ', path)
